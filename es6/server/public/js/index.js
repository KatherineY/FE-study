...
var syy = new _lottery2.default(); //兼容处理
...
var _calculate = __webpack_require__(336);

var _calculate2 = _interopRequireDefault(_calculate);

var _interface = __webpack_require__(337);
    ...
    _createClass(Timer, [{
        ...
        value: function countdown(end, update, handle) {
            ...
            if (now - end > 0) {
                ...
                var px_d = 1000 * 60 * 60 * 24; //一天的毫秒
                var px_h = 1000 * 60 * 60; //一小时
                var px_m = 1000 * 60; //1分
                var px_s = 1000; //1秒
                var d = Math.floor(last_time / px_d); //取整：天
            ...
            if (play[0] === 'r') {
                ...
                if (min_active > 0) {
                    if (min_active - play[1] >= 0) {
                        ...
                        min = Calculate.combine(arr, play[1]).length; //最小命中注数
                    } else {
